...
{
    public interface IZAPTicketService
    {
        // Goal/purpose
        // Handle all ticket related CRUD operations

        // Core CRUD task methods
        public Task AddNewTicketAsync(Ticket ticket);
        public Task UpdateTicketAsync(Ticket ticket);
        public Task<Ticket> GetTicketByIdAsync(int ticketId);
        public Task ArchiveTicketAsync(Ticket ticket);

        // GET tickets: advanced methods
        ...
        public Task<ZUser> GetTicketDeveloperAsync(int ticketId, int companyId);
        ...
        // Lookup ticket pri, status, and ID
